...
if importlib.util.find_spec("pytest") is not None:
    ...
    def test_merge_characters_and_duplicate():
        assert operations.merge_characters_and_duplicate("abcdefg") == "afafafafafafaf"
        assert operations.merge_characters_and_duplicate("12345") == "1414141414"
        assert operations.merge_characters_and_duplicate("A") == "" # Ciag "A" jest za krotki
    ...
    class Test_TestTextOperations(unittest.TestCase):
        ...
        def test_merge_characters_and_duplicate(self):
            self.assertEqual(operations.merge_characters_and_duplicate("abcdefg"), "afafafafafafaf")
            self.assertEqual(operations.merge_characters_and_duplicate("12345"), "1414141414")
            self.assertEqual(operations.merge_characters_and_duplicate("A"),"")
