...
def test_for_map_2_2(
    ...
    assert rectangular_map_2_2.place(animal1) is None
    assert rectangular_map_2_2.place(animal2) is None
    assert rectangular_map_2_2.place(animal3) is True
    assert rectangular_map_2_2.place(animal4) is None
...
def test_for_map_4_4(
    ...
    assert rectangular_map_4_4.place(animal1) is None
    assert rectangular_map_4_4.place(animal2) is True
    assert rectangular_map_4_4.place(animal3) is True
    assert rectangular_map_4_4.place(animal4) is None
...
def test_for_infinite_map(
    ...
    assert infinite_map.place(animal1) is None
